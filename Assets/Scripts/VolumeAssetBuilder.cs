...
public class VolumeAssetBuilder : EditorWindow
{
    ...
    private int width = 256, height = 256, depth = 256;
    private Object asset;

    void OnEnable()
    {
        inputPath = "Assets/Resources/MRI-Head.256x256x256.raw";
        outputPath = "Assets/Resources/MRI.asset";
    }
    ...
    void Build(string inputPath, string outputPath, int width, int height, int depth)
    {
